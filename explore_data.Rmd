...
The training set across all ngrams constitutes roughly 60% of the data, and the other 40% is in the test set. In total, we have roughly 13 million ngrams to build and verify the model. This data is written to files to be used in the prediction app.
